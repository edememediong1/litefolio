...
function Tools() {
  return (
    <div className="h-screen  bg-primary-bg p-10">
        <h2 className="text-[3.5rem] font-[700] font-jamjuree bg-gradient-to-r from-lemon via-dark-light to-purple bg-clip-text text-transparent">Tools I have used</h2>
        ...
        <article className="flex justify-between items-center h-[70%]">
            ...
            <section className="w-[50%] flex justify-start items-start mt-0 p-0">
