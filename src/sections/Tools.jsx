...
function Tools() {
  return (
    <div className="tools-cont h-screen  bg-primary-bg p-10">
        <p className="tools-head text-[3.5rem] font-[700] font-jamjuree bg-gradient-to-r from-lemon via-dark-light to-purple bg-clip-text text-transparent">Tools I have used</p>
