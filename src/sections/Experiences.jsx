...
function Experiences() {
  ...
  return (
    ...
    <div className="h-auto bg-primary-bg p-10">
        ...
        <p className="text-[20px] font-jamjuree text-dark-light mt-[20px] mb-[25px]">With 2 years of experience as a designer and developer, I have worked with many clients worldwide, built numerous frontend, backend, and AI applications, managed various projects, and contributed to Opensource projects</p>
                ...
                <div key={index} className={` bg-bg-light transition-all duration-300 ease-in-out ${activeIndex === index ? 'h-auto': 'h-[133px] overflow-hidden'}`}>
                    <div  onClick={() => toggleAccordion(index)} className="grid grid-cols-5 cursor-pointer h-[133px] ">
                      ...
                      <section className="col-span-3 flex-col justify-center items-start bg-[#1b2335] p-4">
                        <h3 className="text-xl text-[25px] font-bakbak bg-gradient-to-r from-lemon via-purple to-dark-light bg-clip-text text-transparent">{item.role}</h3>
                        <p className="text-[20px] text-[#c2bad2] font-jamjuree">{item.company}</p>
